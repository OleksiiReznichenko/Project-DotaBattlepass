...
const idleFrames = ref(importAll(import.meta.glob("/src/assets/sprites/Shadow_Fiend/Idle/*")));
...
onMounted(() => {
  _idleAnimation.value = new TileAnimation(canvas.value, 1300, 1000, idleFrames.value);
